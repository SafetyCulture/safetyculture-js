...
var _exportProfiles = require('./export-profiles');

var _exportProfiles2 = _interopRequireDefault(_exportProfiles);
...
function Client(_ref) {
  ...
  return {
    ...
    exportProfiles: (0, _exportProfiles2.default)(api, logger),
